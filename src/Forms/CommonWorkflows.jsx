...
class CommonWorkflows extends React.Component {
  render() {
    const { onClickCancelPayment, cancelablePayment, workFlowDisabled } = this.props;
    return (
      <Section>
        <Group direction="column" spacing={16}>
          ...
          <Group direction="column" spacing={8}>
            ...
            <Button color="white" onClick={onClickCancelPayment} disabled={!cancelablePayment} justifyContent="left">
              <Group direction="row">
                <Icon icon="cancel" />
                <Text color="blue" size={14}>
                  Cancel payment
